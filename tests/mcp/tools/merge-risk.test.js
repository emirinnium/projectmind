 ...
 */
function seedBlastRadius(db) {
    const insertFile = db.prepare('INSERT INTO files (project_id, path, relative_path, language, size_bytes, hash) VALUES (?, ?, ?, ?, ?, ?)');
...
//# sourceMappingURL=merge-risk.test.js.map