...
import { CrossProjectPatternEngine, normalizeAbstractionLevel, buildPattern, defaultSuccessMetrics, } from '../../../src/core/patterns/cross-project.js';
...
describe('CrossProjectPatternEngine', () => {
    ...
    it('requires an explicit database', () => {
        expect(() => new CrossProjectPatternEngine(undefined)).toThrow(/explicit database/i);
        expect(() => new CrossProjectPatternEngine(null)).toThrow(/explicit database/i);
    });
...
//# sourceMappingURL=cross-project.test.js.map