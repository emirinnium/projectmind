...
import { classifyPath, confineToProject, confinePathValueFlags, isPathInside, PathEscapesProjectError, } from '../../src/mcp/tools/_shared.js';
...
describe('K4: confinePathValueFlags (CLI -o / --output / --config escapes)', () => {
    ...
    it('rejects the --output= form', () => {
        expect(() => confinePathValueFlags(['doctor', 'scan-health', `--output=${resolve(ROOT, '..', 'x.json')}`], ROOT)).toThrow(PathEscapesProjectError);
    });
...
//# sourceMappingURL=mcp-shared.test.js.map