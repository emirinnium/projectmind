...
import type { ProjectMindRc } from '../../src/utils/config-schema.js';
...
function merge(overrides: Partial<ProjectMindRc> = {}) {
  return mergeWithDefaults({ projectRoot: FAKE_ROOT, ...overrides } as ProjectMindRc);
}
