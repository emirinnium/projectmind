  ...
  server.registerTool(
    'resolve_import',
    {
      ...
      inputSchema: {
        importPath: z
          .string()
          .describe('The import path to resolve (e.g., "./utils", "@/components/Button")'),
        fromFilePath: z
          .string()
          .optional()
          .describe('Optional: the file containing the import (for relative resolution)'),
      },
    },
    async (args) => {
  ...
  server.registerTool(
    'get_dependency_graph',
    {
      ...
      inputSchema: {
        modulePath: z
          .string()
          .describe('Path of the module/directory (e.g., "src/core", "src/utils")'),
      },
    },
    async (args) => {
